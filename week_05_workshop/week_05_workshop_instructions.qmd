...
First, make sure this document is in your `si_analytics_python` folder, where your virtual environment is activated and you have pandas installed.
...
Download the lending club dataset from GitHub here[https://github.com/SIAnalyticsLab/pdav_q1-2026_materials/blob/main/week_05_workshop/data/loans_full_schema.csv](https://github.com/SIAnalyticsLab/pdav_q1-2026_materials/blob/main/week_05_workshop/data/loans_full_schema.csv) then place it in an appropriate place in your `si_analytics_python` folder.
