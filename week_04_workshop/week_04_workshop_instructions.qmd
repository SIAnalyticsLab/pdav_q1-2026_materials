...
Download this instructions file to your computer, then add it to your si_analytics_python folder in VS Code. Then in the extensions panel, install the "vscode-pdf" extension. This should allow you open these instructions directly in VS Code, making it easier to follow along.

# Steps

1) In your si_analytics_python folder, create a new Quarto file (.qmd) called `week_04_workshop.qmd` using the side panel.
...
5) Download the dataset from this link, unzip it (extract all on Windows), then copy the file into a data folder in your si_analytics_python repository.

[https://github.com/SIAnalyticsLab/pdav_q1-2026_materials/raw/refs/heads/main/week_04_workshop/data/india_tb_pathways_and_costs.zip](https://github.com/SIAnalyticsLab/pdav_q1-2026_materials/raw/refs/heads/main/week_04_workshop/data/india_tb_pathways_and_costs.zip)
...
[https://github.com/SIAnalyticsLab/pdav_q1-2026_materials/blob/main/week_04_workshop/images/tndistrict_1.png](https://github.com/SIAnalyticsLab/pdav_q1-2026_materials/blob/main/week_04_workshop/images/tndistrict_1.png)
